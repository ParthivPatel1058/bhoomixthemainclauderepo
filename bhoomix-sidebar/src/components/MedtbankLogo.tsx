...
export const LeafIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  ...
  >
    {/* Stylized Medtbank leaf logo with organic curved petal & subtle leaf notch */}
    <path
...
export const MedtbankLogo: React.FC<MedtbankLogoProps> = ({
  theme = 'dark',
  collapsed = false,
  className = '',
  onClick,
