...
// Custom SVG Icons matching user-provided reference images
// Image 1: Overview - Clipboard with 3-item checklist
export const OverviewIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
...
// Image 2: Crop Intelligence - Smartphone scanning plant with camera frame & touch gesture
export const CropIntelligenceIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Corner Viewfinder brackets */}
    <path d="M1.5 5.5V2.5H4.5M19.5 2.5H22.5V5.5M1.5 17V19.5H4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    {/* Plant sprout growing out of top */}
    <path d="M10.5 10V6C10.5 3.8 8.5 2 6 2C6 4.5 7.8 6.5 10 6.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M10.5 5C12 3 14.5 2.2 16.5 2.5C17 4.8 15 7 12 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    {/* Phone body */}
    <rect x="2" y="9.5" width="15" height="10" rx="2.5" stroke="currentColor" strokeWidth="1.8" />
    {/* Screen circle with plant icon */}
    <circle cx="8.5" cy="14.5" r="3" stroke="currentColor" strokeWidth="1.4" />
    <path d="M7 15.5C7.5 14 8.5 13.5 9 13.5C9.5 13.5 10.5 14 11 15.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    {/* Hand touching screen */}
    <path d="M13.5 18L15.5 13.8C16 12.8 17.2 12.5 18.2 13C19.2 13.5 19.5 14.7 19 15.7L17.8 17.8M17.8 17.8L19.5 19.5C20.8 20.8 20.5 22.8 18.5 22.8H14.5L13 20.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

// Image 3: Crop Advisory - Double overlapping rounded speech chat bubbles
export const CropAdvisoryIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Back chat bubble */}
    <path
...
// Image 4: Agri Market - Retail market storefront with awning & doorway
export const AgriMarketIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Roof bar */}
...
// Image 5: Farming Guides - Sprout emerging from soil mound
export const FarmingGuidesIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Soil mound at base */}
    <path
...
// Image 6: Damage Claim - Document with "CLAIM" heading and Shield with plus sign
export const DamageClaimIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Sheet outline */}
    <path
    ...
    {/* Ruled lines */}
    <path d="M9 9.5H17.5M9 12.2H17.5M11.5 15H17.5M11.5 17.8H17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    {/* Shield on bottom-left */}
    <path
...
// Image 7: Orders - Shopping cart loaded with groceries (baguette, bottle, pouch)
export const OrdersIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Baguette on left */}
    <path d="M4 6.5L5.5 3C5.8 2.3 6.8 2.3 7.1 3L8.5 7" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    {/* Bottle */}
    <path d="M12 2H14V3.5L15 5V7H11V5L12 3.5V2Z" fill="currentColor" />
    {/* Produce pouch / sack */}
    <path d="M17 4.5C16.5 3.5 18 2.5 19 3C19.5 3.5 19 4.5 18.5 5C19.5 5.5 20.5 6.5 20 8H16.5C16 6.5 16.5 5.5 17 4.5Z" fill="currentColor" />
    {/* Shopping Cart Body */}
    <path
...
export const NavIcon: React.FC<{
  ...
  switch (name) {
    case 'overview':
      // User Image 1: Clipboard with checklist
      return <OverviewIcon className={className} />;
    case 'crop-intelligence':
      // User Image 2: Smartphone scanning plant with camera bracket & touch gesture
      return <CropIntelligenceIcon className={className} />;
    case 'crop-advisory':
      // User Image 3: Double overlapping speech bubbles
      return <CropAdvisoryIcon className={className} />;
    case 'agri-market':
      // User Image 4: Storefront with striped awning & door
      return <AgriMarketIcon className={className} />;
    case 'farming-guides':
      // User Image 5: Sprout emerging from soil mound
    ...
    case 'mandi-prices':
      // Skipped as requested - keep existing APMC Rupee rate icon
      return <BadgeIndianRupee className={className} strokeWidth={1.8} />;
    case 'damage-claim':
      // User Image 6: Document with "CLAIM" heading and Shield
      return <DamageClaimIcon className={className} />;
    case 'schemes':
      // Skipped as requested - keep existing Landmark/Govt pillars icon
      return <Landmark className={className} strokeWidth={1.8} />;
    case 'orders':
      // User Image 7: Shopping cart filled with groceries
