...
export default function Surface({
  ...
  return (
    <Tag
      className={cn(
        'rounded-lg transition-[transform,box-shadow,border-color,background-color,color,opacity,filter] duration-500 [transition-timing-function:var(--ease-editorial)]',
        VARIANT[variant],
        PADDING[padding],
        interactive &&
