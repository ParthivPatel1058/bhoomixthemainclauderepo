/**
 * Hand-authored UI strings.
 *
 * English is the source of truth: the other Eighth Schedule languages are
 * machine-translated from these English values and cached server-side.
 * Hindi is authored by hand because it carries most of the traffic.
 */
